...
from dataloaders.piano import PIANO

# data_dir = '/content/drive/My Drive/Dissertation Code/pianoDetectData/train'
# batch_size = 4
# dataset = PIANO(data_dir=data_dir, batch_size=batch_size, split='train', shuffle=True, num_workers=4)
...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        print(f"Total training batches: {len(self.train_loader)}")
        ...
        for batch_idx, (data, target) in enumerate(tbar):
            print(f"Processing batch {batch_idx+1}/{len(tbar)}...")
